...
Over time, I have noticed that some of us (me included) may *think we need* to learn something (as opposed to *wanting to learn something*) for whatever reasons -- getting promotion at work, gaining a certificate, adding something to CV or just "stay up to date" with recent hypes, one of them being Test-Driven Development. Such motivation may be difficult to sustain over the long term.
