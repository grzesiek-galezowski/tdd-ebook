...
1.  [It will be very hard](http://www.netobjectives.com/blogs/shalloway%E2%80%99s-law-and-shalloway%E2%80%99s-principle) to find all these places and chances are you'll miss at least one. If so, a bug might creep in.
...
[^csharpoperatorsoverride]: and, for C#, overriding equality operators (`==` and `!=`) is probably a good idea as well, not to mention `GetHashCode()`. See https://msdn.microsoft.com/en-us/library/vstudio/7h9bszxx(v=vs.100).aspx
