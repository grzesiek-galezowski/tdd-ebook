...
graph_g = GraphViz.digraph( "G", :use => :neato ) { |graph_g|
  ...
  node_red = graph_g.add_nodes( "Red", :fontsize => '11', :height => '', :label => '<Write an <B>unfulfilled</B><br/> Statement>', :pos => '2,2!', :shape => 'Mrecord', :style => '', :width => '' )
  graph_g.add_edges( "Red", "Green", :fontsize => '11' )
  node_green = graph_g.add_nodes( "Green", :fontsize => '11', :height => '', :label => 'Fulfill it', :pos => '4.2,2!', :shape => 'Mrecord', :style => '', :width => '' )
